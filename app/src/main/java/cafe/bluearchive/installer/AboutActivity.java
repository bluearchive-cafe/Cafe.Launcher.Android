...
public final class AboutActivity extends AppCompatActivity {
    private static final String REPOSITORY_URL = "https://github.com/bluearchive-cafe/Cafe.Launcher.Android";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SystemBars.applyTopAndBottomInsets(this, toolbar, findViewById(R.id.about_scroll));
    ...
    private void configureAboutList() {
        ...
        bindListItem(versionItem, R.drawable.ic_info_outline_24,
                getString(R.string.about_item_app_version), appVersionName(), false);

        View sourceCodeItem = findViewById(R.id.item_source_code);
        bindListItem(sourceCodeItem, R.drawable.ic_code_24,
                getString(R.string.about_item_source_code), null, true);
        sourceCodeItem.setOnClickListener(view ->
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(REPOSITORY_URL))));

        View licensesItem = findViewById(R.id.item_licenses);
        bindListItem(licensesItem, R.drawable.ic_description_outline_24,
                getString(R.string.about_item_licenses), null, true);
        licensesItem.setOnClickListener(view ->
                startActivity(new Intent(this, LicensesActivity.class)));
    }

    private void bindListItem(View item, int iconRes, String titleText,
                              String subtitleText, boolean actionable) {
